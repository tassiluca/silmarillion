            ...
            <aside>
                ...
                <header>
                    <ul id="productInfo">
                        ...
                        <li class="<?php if($templateParams["copies"] > 0){echo "available";}else{echo "soldout";}?>"><?php if($templateParams["copies"] > 0){echo $templateParams["copies"] ." copie disponibili";}else{echo "Non disponibile";}?></li><li><a href="/utils/process-request.php?action=wish&id=<?php echo $templateParams["product"]["ProductId"]?>" class="wishButton"><img src="<?php echo $favImg?>" alt="Preferito" /></a></li><li><a href="/utils/process-request.php?action=notify&id=<?php echo $templateParams["product"]["ProductId"]?>" <?php if(!$templateParams["logged"]){ echo 'class="disabled"';}?>>Avvisami quando questo prodotto sarà disponibile</a></li>
                    </ul>
